 ...
 */
- (double)match:(Mat*)_face_feature1 _face_feature2:(Mat*)_face_feature2 dis_type:(int)dis_type NS_SWIFT_NAME(match(_face_feature1:_face_feature2:dis_type:));
 ...
 * @param _face_feature2 the second input feature of the same size and the same type as _face_feature1
 */
- (double)match:(Mat*)_face_feature1 _face_feature2:(Mat*)_face_feature2 NS_SWIFT_NAME(match(_face_feature1:_face_feature2:));
